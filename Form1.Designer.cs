namespace WindowsFormsApp2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "This program demonstrate how knight can move in CHESS game so that it can cover a" +
    "ll square without using the same square again. Click on Find Solution button and" +
    " it will show all 64 moves.";
            // 
            // Form1
            // 
